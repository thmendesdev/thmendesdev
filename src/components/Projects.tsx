...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    {
      title: t('arcflowTitle'),
      description: t('arcflowDesc'),
      image: '/projects/arcflow.png',
      category: ['React', 'TypeScript', 'Tailwind CSS', 'Vite'],
      link: 'https://arcflow-fast.vercel.app/',
      github: `${GITHUB_BASE}/arcflow`,
      showViewCode: true,
    },
    {
    ...
    },
    {
      ...
      description: t('differentDesc'),
      image: '/projects/different.png',
      category: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion'],
      link: 'https://different-faster.vercel.app/',
      github: `${GITHUB_BASE}/different`,
      showViewCode: true,
    },
    {
      title: t('usabitTitle'),
